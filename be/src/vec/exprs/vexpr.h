...
public:
    ...
    static doris::Status create_expr_tree(doris::ObjectPool* pool, const doris::TExpr& texpr,
                                          VExprContext** ctx);

    static doris::Status create_expr(doris::ObjectPool* pool, const doris::TExprNode& texpr_node,
                                     VExpr** expr);

    static doris::Status create_tree_from_thrift(doris::ObjectPool* pool,
                                                 const std::vector<doris::TExprNode>& nodes,
