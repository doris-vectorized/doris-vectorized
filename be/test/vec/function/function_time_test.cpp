...
TEST(TimestampFunctionsTest, quarter_test) {
    ...
    std::vector<std::pair<std::vector<std::any>, std::any>> data_set = {
            {{std::string("2021-01-01 00:00:00")}, 1},
            {{std::string("")}, Null()},
...
TEST(TimestampFunctionsTest, hour_test) {
    ...
    std::vector<std::pair<std::vector<std::any>, std::any>> data_set = {
            {{std::string("2021-01-01 23:59:59")}, 23},
...
TEST(TimestampFunctionsTest, minute_test) {
    ...
    std::vector<std::pair<std::vector<std::any>, std::any>> data_set = {
            {{std::string("2021-01-01 23:59:50")}, 59},
...
TEST(TimestampFunctionsTest, second_test) {
    ...
    std::vector<std::pair<std::vector<std::any>, std::any>> data_set = {
            {{std::string("2021-01-01 23:50:59")}, 59},
...
TEST(TimestampFunctionsTest, years_add_test) {
    ...
    std::vector<vectorized::TypeIndex> input_types = {vectorized::TypeIndex::DateTime, vectorized::TypeIndex::Int32};

    std::vector<std::pair<std::vector<std::any>, std::any>> data_set = {
            {{std::string("2020-05-23 00:00:00"),5}, vectorized::str_to_data_time("2025-05-23 00:00:00")},
            {{std::string("2020-05-23 00:00:00"),-5}, vectorized::str_to_data_time("2015-05-23 00:00:00")},
            {{std::string(""),5}, Null()},
...
TEST(TimestampFunctionsTest, months_add_test) {
    ...
    std::vector<std::pair<std::vector<std::any>, std::any>> data_set = {
            {{std::string("2020-10-23 00:00:00"),-4}, vectorized::str_to_data_time("2020-06-23 00:00:00")},
            {{std::string("2020-05-23 00:00:00"),4}, vectorized::str_to_data_time("2020-09-23 00:00:00")},
            {{std::string(""),4}, Null()},
            {{std::string("2020-05-23 00:00:00"),10}, vectorized::str_to_data_time("2021-03-23 00:00:00")},
            {{Null(),4}, Null()}
    };
...
TEST(TimestampFunctionsTest, months_sub_test) {
    ...
    std::vector<std::pair<std::vector<std::any>, std::any>> data_set = {
            {{std::string("2020-05-23 00:00:00"),4}, vectorized::str_to_data_time("2020-01-23 00:00:00")},
            {{std::string("2020-05-23 00:00:00"),-4}, vectorized::str_to_data_time("2020-09-23 00:00:00")},
            {{std::string(""),4}, Null()},
            {{std::string("2020-05-23 00:00:00"),10}, vectorized::str_to_data_time("2019-07-23 00:00:00")},
            {{Null(),4}, Null()}
    };
...
TEST(TimestampFunctionsTest, days_add_test) {
    ...
    std::vector<std::pair<std::vector<std::any>, std::any>> data_set = {
            {{std::string("2020-10-23 00:00:00"),-4}, vectorized::str_to_data_time("2020-10-19 00:00:00")},
            {{std::string("2020-05-23 00:00:00"),4}, vectorized::str_to_data_time("2020-05-27 00:00:00")},
            {{std::string(""),4}, Null()},
            {{std::string("2020-05-23 00:00:00"),10},vectorized::str_to_data_time("2020-06-2 00:00:00")},
            {{Null(),4}, Null()}
    };
...
TEST(TimestampFunctionsTest, days_sub_test) {
    ...
    std::vector<std::pair<std::vector<std::any>, std::any>> data_set = {
            {{std::string("2020-05-23 00:00:00"),4}, vectorized::str_to_data_time("2020-05-19 00:00:00")},
            {{std::string("2020-05-23 00:00:00"),-4}, vectorized::str_to_data_time("2020-05-27 00:00:00")},
            {{std::string(""),4}, Null()},
            {{std::string("2020-05-23 00:00:00"),31}, vectorized::str_to_data_time("2020-04-22 00:00:00")},
            {{Null(),4}, Null()}
    };
...
TEST(TimestampFunctionsTest, hours_add_test) {
    ...
    std::vector<std::pair<std::vector<std::any>, std::any>> data_set = {
            {{std::string("2020-10-23 10:00:00"),-4}, vectorized::str_to_data_time("2020-10-23 06:00:00")},
            {{std::string("2020-05-23 10:00:00"),4}, vectorized::str_to_data_time("2020-05-23 14:00:00")},
            {{std::string(""),4}, Null()},
            {{std::string("2020-05-23 10:00:00"),100},vectorized::str_to_data_time("2020-05-27 14:00:00")},
            {{Null(),4}, Null()}
    };
...
TEST(TimestampFunctionsTest, hours_sub_test) {
    ...
    std::vector<std::pair<std::vector<std::any>, std::any>> data_set = {
            {{std::string("2020-05-23 10:00:00"),4}, vectorized::str_to_data_time("2020-05-23 06:00:00")},
            {{std::string("2020-05-23 10:00:00"),-4}, vectorized::str_to_data_time("2020-05-23 14:00:00")},
            {{std::string(""),4}, Null()},
            {{std::string("2020-05-23 10:00:00"),31}, vectorized::str_to_data_time("2020-05-22 03:00:00")},
            {{Null(),4}, Null()}
    };
...
TEST(TimestampFunctionsTest, minutes_add_test) {
    ...
    std::vector<std::pair<std::vector<std::any>, std::any>> data_set = {
            {{std::string("2020-10-23 10:00:00"),40}, vectorized::str_to_data_time("2020-10-23 10:40:00")},
            {{std::string("2020-05-23 10:00:00"),-40}, vectorized::str_to_data_time("2020-05-23 09:20:00")},
            {{std::string(""),4}, Null()},
            {{std::string("2020-05-23 10:00:00"),100},vectorized::str_to_data_time("2020-05-23 11:40:00")},
            {{Null(),4}, Null()}
    };
...
TEST(TimestampFunctionsTest, minutes_sub_test) {
    ...
    std::vector<std::pair<std::vector<std::any>, std::any>> data_set = {
            {{std::string("2020-05-23 10:00:00"),40}, vectorized::str_to_data_time("2020-05-23 09:20:00")},
            {{std::string("2020-05-23 10:00:00"),-40}, vectorized::str_to_data_time("2020-05-23 10:40:00")},
            {{std::string(""),4}, Null()},
            {{std::string("2020-05-23 10:00:00"),100}, vectorized::str_to_data_time("2020-05-23 08:20:00")},
            {{Null(),4}, Null()}
    };
...
TEST(TimestampFunctionsTest, seconds_add_test) {
    ...
    std::vector<std::pair<std::vector<std::any>, std::any>> data_set = {
            {{std::string("2020-10-23 10:00:00"),40}, vectorized::str_to_data_time("2020-10-23 10:00:40")},
            {{std::string("2020-05-23 10:00:00"),-40}, vectorized::str_to_data_time("2020-05-23 09:59:20")},
            {{std::string(""),4}, Null()},
            {{std::string("2020-05-23 10:00:00"),100},vectorized::str_to_data_time("2020-05-23 10:01:40")},
            {{Null(),4}, Null()}
    };
...
TEST(TimestampFunctionsTest, seconds_sub_test) {
    ...
    std::vector<std::pair<std::vector<std::any>, std::any>> data_set = {
            {{std::string("2020-05-23 10:00:00"),40}, vectorized::str_to_data_time("2020-05-23 09:59:20")},
            {{std::string("2020-05-23 10:00:00"),-40}, vectorized::str_to_data_time("2020-05-23 10:00:40")},
            {{std::string(""),4}, Null()},
            {{std::string("2020-05-23 10:00:00"),100}, vectorized::str_to_data_time("2020-05-23 09:58:20")},
            {{Null(),4}, Null()}
    };
...
TEST(TimestampFunctionsTest, weeks_add_test) {
    ...
    std::vector<std::pair<std::vector<std::any>, std::any>> data_set = {
            {{std::string("2020-10-23 10:00:00"),5}, vectorized::str_to_data_time("2020-11-27 10:00:00")},
            {{std::string("2020-05-23 10:00:00"),-5}, vectorized::str_to_data_time("2020-04-18 10:00:00")},
            {{std::string(""),4}, Null()},
            {{std::string("2020-05-23 10:00:00"),100},vectorized::str_to_data_time("2022-04-23 10:00:00")},
            {{Null(),4}, Null()}
    };
...
TEST(TimestampFunctionsTest, weeks_sub_test) {
    ...
    std::vector<std::pair<std::vector<std::any>, std::any>> data_set = {
            {{std::string("2020-05-23 10:00:00"),5}, vectorized::str_to_data_time("2020-04-18 10:00:00")},
            {{std::string("2020-05-23 10:00:00"),-5}, vectorized::str_to_data_time("2020-6-27 10:00:00")},
            {{std::string(""),4}, Null()},
            {{std::string("2020-05-23 10:00:00"),100}, vectorized::str_to_data_time("2018-06-23 10:00:00")},
            {{Null(),4}, Null()}
    };
...
TEST(TimestampFunctionsTest, date_test) {
    ...
    std::vector<std::pair<std::vector<std::any>, std::any>> data_set = {
            {{std::string("2021-01-01 06:00:00")}, vectorized::str_to_data_time("2021-01-01", false)},
            {{std::string("")}, Null()},
            {{Null()}, Null()},
            {{std::string("0000-01-01 00:00:00")}, vectorized::str_to_data_time("0000-01-01", false)}
    };
