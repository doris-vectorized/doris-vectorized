...
visible_functions = [
    ...
    [['unix_timestamp'], 'INT', ['DATETIME'],
        '_ZN5doris18TimestampFunctions7to_unixEPN9doris_udf15FunctionContextERKNS1_11DateTimeValE', 'vec'],
    ...
    [['from_unixtime'], 'VARCHAR', ['INT'],
        '_ZN5doris18TimestampFunctions9from_unixEPN9doris_udf15FunctionContextERKNS1_6IntValE', 'vec'],
    ...
    [['timestamp'], 'DATETIME', ['DATETIME'],
        '_ZN5doris18TimestampFunctions9timestampEPN9doris_udf15FunctionContextERKNS1_11DateTimeValE', 'vec'],
    ...
    [['month'], 'INT', ['DATETIME'],
        '_ZN5doris18TimestampFunctions5monthEPN9doris_udf15FunctionContextERKNS1_11DateTimeValE', 'vec'],
    [['quarter'], 'INT', ['DATETIME'],
        '_ZN5doris18TimestampFunctions7quarterEPN9doris_udf15FunctionContextERKNS1_11DateTimeValE', 'vec'],
    [['dayofweek'], 'INT', ['DATETIME'],
        '_ZN5doris18TimestampFunctions11day_of_weekEPN9doris_udf15FunctionContextERKNS1_11DateTimeValE', 'vec'],
    ...
    [['hour'], 'INT', ['DATETIME'],
        '_ZN5doris18TimestampFunctions4hourEPN9doris_udf15FunctionContextERKNS1_11DateTimeValE', 'vec'],
    [['minute'], 'INT', ['DATETIME'],
        '_ZN5doris18TimestampFunctions6minuteEPN9doris_udf15FunctionContextERKNS1_11DateTimeValE', 'vec'],
    [['second'], 'INT', ['DATETIME'],
        '_ZN5doris18TimestampFunctions6secondEPN9doris_udf15FunctionContextERKNS1_11DateTimeValE', 'vec'],
    ...
    [['date', 'to_date'], 'DATE', ['DATETIME'],
        '_ZN5doris18TimestampFunctions7to_dateEPN9doris_udf15FunctionContextERKNS1_11DateTimeValE', 'vec'],
    ...
    # function name
    [['if'], 'BOOLEAN', ['BOOLEAN', 'BOOLEAN', 'BOOLEAN'], '', 'vec'],
    [['if'], 'TINYINT', ['BOOLEAN', 'TINYINT', 'TINYINT'], '', 'vec'],
    [['if'], 'SMALLINT', ['BOOLEAN', 'SMALLINT', 'SMALLINT'], '', 'vec'],
    [['if'], 'INT', ['BOOLEAN', 'INT', 'INT'], '', 'vec'],
    [['if'], 'BIGINT', ['BOOLEAN', 'BIGINT', 'BIGINT'], '', 'vec'],
    [['if'], 'LARGEINT', ['BOOLEAN', 'LARGEINT', 'LARGEINT'], '', 'vec'],
    [['if'], 'FLOAT', ['BOOLEAN', 'FLOAT', 'FLOAT'], '', 'vec'],
    [['if'], 'DOUBLE', ['BOOLEAN', 'DOUBLE', 'DOUBLE'], '', 'vec'],
    [['if'], 'DATETIME', ['BOOLEAN', 'DATETIME', 'DATETIME'], '', 'vec'],
    [['if'], 'DATE', ['BOOLEAN', 'DATE', 'DATE'], '', 'vec'],
    [['if'], 'DECIMAL', ['BOOLEAN', 'DECIMAL', 'DECIMAL'], '', 'vec'],
    [['if'], 'DECIMALV2', ['BOOLEAN', 'DECIMALV2', 'DECIMALV2'], '', 'vec'],
    ...
    [['nullif'], 'BOOLEAN', ['BOOLEAN', 'BOOLEAN'], '', 'vec'],
    [['nullif'], 'TINYINT', ['TINYINT', 'TINYINT'], '', 'vec'],
    [['nullif'], 'SMALLINT', ['SMALLINT', 'SMALLINT'], '', 'vec'],
    [['nullif'], 'INT', ['INT', 'INT'], '', 'vec'],
    [['nullif'], 'BIGINT', ['BIGINT', 'BIGINT'], '', 'vec'],
    [['nullif'], 'LARGEINT', ['LARGEINT', 'LARGEINT'], '', 'vec'],
    [['nullif'], 'FLOAT', ['FLOAT', 'FLOAT'], '', 'vec'],
    [['nullif'], 'DOUBLE', ['DOUBLE', 'DOUBLE'], '', 'vec'],
    [['nullif'], 'DATETIME', ['DATETIME', 'DATETIME'], '', 'vec'],
    [['nullif'], 'DATE', ['DATE', 'DATE'], '', 'vec'],
    [['nullif'], 'DECIMAL', ['DECIMAL', 'DECIMAL'], '', 'vec'],
    [['nullif'], 'DECIMALV2', ['DECIMALV2', 'DECIMALV2'], '', 'vec'],
    # The priority of varchar should be lower than decimal in IS_SUPERTYPE_OF mode.
    [['nullif'], 'VARCHAR', ['VARCHAR', 'VARCHAR'], '', 'vec'],

    [['ifnull'], 'BOOLEAN', ['BOOLEAN', 'BOOLEAN'], '', 'vec'],
    [['ifnull'], 'TINYINT', ['TINYINT', 'TINYINT'], '', 'vec'],
    [['ifnull'], 'SMALLINT', ['SMALLINT', 'SMALLINT'], '', 'vec'],
    [['ifnull'], 'INT', ['INT', 'INT'], '', 'vec'],
    [['ifnull'], 'BIGINT', ['BIGINT', 'BIGINT'], '', 'vec'],
    [['ifnull'], 'LARGEINT', ['LARGEINT', 'LARGEINT'], '', 'vec'],
    [['ifnull'], 'FLOAT', ['FLOAT', 'FLOAT'], '', 'vec'],
    [['ifnull'], 'DOUBLE', ['DOUBLE', 'DOUBLE'], '', 'vec'],
    [['ifnull'], 'DATE', ['DATE', 'DATE'], '', 'vec'],
    [['ifnull'], 'DATETIME', ['DATETIME', 'DATETIME'], '', 'vec'],
    [['ifnull'], 'DATETIME', ['DATE', 'DATETIME'], '', 'vec'],
    [['ifnull'], 'DATETIME', ['DATETIME', 'DATE'], '', 'vec'],
    [['ifnull'], 'DECIMAL', ['DECIMAL', 'DECIMAL'], '', 'vec'],
    [['ifnull'], 'DECIMALV2', ['DECIMALV2', 'DECIMALV2'], '', 'vec'],
    [['ifnull'], 'BITMAP', ['BITMAP', 'BITMAP'], '', 'vec'],
    # The priority of varchar should be lower than decimal in IS_SUPERTYPE_OF mode.
    [['ifnull'], 'VARCHAR', ['VARCHAR', 'VARCHAR'], '', 'vec'],
    ...
    [['char_length', 'character_length'], 'INT', ['VARCHAR'],
            '_ZN5doris15StringFunctions16char_utf8_lengthEPN9doris_udf15FunctionContextERKNS1_9StringValE', 'vec'],
    ...
    [['bitmap_hash'], 'BITMAP', ['VARCHAR'],
        '_ZN5doris15BitmapFunctions11bitmap_hashEPN9doris_udf15FunctionContextERKNS1_9StringValE', 'vec'],
    [['bitmap_count'], 'BIGINT', ['BITMAP'],
        '_ZN5doris15BitmapFunctions12bitmap_countEPN9doris_udf15FunctionContextERKNS1_9StringValE', 'vec'],
    [['bitmap_empty'], 'BITMAP', [],
        '_ZN5doris15BitmapFunctions12bitmap_emptyEPN9doris_udf15FunctionContextE', 'vec'],
    [['bitmap_or'], 'BITMAP', ['BITMAP','BITMAP'],
        '_ZN5doris15BitmapFunctions9bitmap_orEPN9doris_udf15FunctionContextERKNS1_9StringValES6_', 'vec'],
    [['bitmap_xor'], 'BITMAP', ['BITMAP','BITMAP'],
        '_ZN5doris15BitmapFunctions10bitmap_xorEPN9doris_udf15FunctionContextERKNS1_9StringValES6_', 'vec'],
    [['bitmap_not'], 'BITMAP', ['BITMAP','BITMAP'],
        '_ZN5doris15BitmapFunctions10bitmap_notEPN9doris_udf15FunctionContextERKNS1_9StringValES6_', 'vec'],
    ...
    [['bitmap_to_string'], 'VARCHAR', ['BITMAP'],
        '_ZN5doris15BitmapFunctions16bitmap_to_stringEPN9doris_udf15FunctionContextERKNS1_9StringValE', 'vec'],
    [['bitmap_from_string'], 'BITMAP', ['VARCHAR'],
        '_ZN5doris15BitmapFunctions18bitmap_from_stringEPN9doris_udf15FunctionContextERKNS1_9StringValE', 'vec'],
    ...
    [['bitmap_has_any'], 'BOOLEAN', ['BITMAP','BITMAP'],
        '_ZN5doris15BitmapFunctions14bitmap_has_anyEPN9doris_udf15FunctionContextERKNS1_9StringValES6_', 'vec'],
